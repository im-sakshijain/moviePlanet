...
import com.personal.movieplanet.exception.NotFoundException;
import com.personal.movieplanet.repository.ShowRepository;
import com.personal.movieplanet.repository.TicketRepository;
...
public class TicketService {
	...
	public TicketDto bookTicket(BookingDto bookingResource) {
		...
		try {
			TicketMessageDto message = new TicketMessageDto(ticket.getUser().getName(),ticket.getUser().getMobile(),ticket.getUser().getEmail(), ticket.getShow(), ticket.getSeats());
